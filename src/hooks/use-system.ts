...
export const FREE_ZEN_MODELS = [
  {
    ...
    assignedRole: "coder",
    description: "توليد كود سريع والتخطيط",
    available: true,
  },
  {
    id: "big-pickle",
    name: "Big Pickle",
    assignedRole: "coder",
    description: "مساعد برمجة متعدد الملفات بالتوازي",
    available: true,
  },
  {
    id: "mimo-v2.5-free",
    ...
    description: "الرؤية والمحادثة وتنسيق المهام",
    available: true,
  },
  {
    id: "hy3-free",
    ...
    description: "تفكير عميق وتخطيط ومراجعة",
    available: true,
  },
  {
    ...
    description: "سلامة التبعيات ونظافة الكود",
    available: true,
  },
  {
    ...
    description: "مهام كبيرة واختبار وتصحيح",
    available: true,
  },
] as const;
